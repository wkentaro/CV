...
\BulletItem
\textbf{Coding and software development} with Python and C++ for deep learning, volumetric reconstruction, 2D/3D visualization, physics simulation, CLI tools, and GUI/Web applications.
